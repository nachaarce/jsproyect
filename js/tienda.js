...
let stockExpansiones = [ 
    {id: 1 , nombre: "Rumbo a la fama", cantidad: 1, precio: 1550, img: '../gallery/exp-fama.png'},
    {id: 2 , nombre: "Vida de Universidad",cantidad: 1,  precio: 1500 , img: '../gallery/exp-univ.png'},       
    {id: 3 , nombre:  "Vida en la Isla"  ,cantidad:  1  ,  precio: 1700 ,  img: '../gallery/exp-isla.png' },
    {id: 4, nombre: "Noche de Cine"   ,cantidad:  1   ,  precio:  900  ,  img: '../gallery/pk-cine.png'  },      
    {id: 5, nombre: "Mascotas"   , cantidad: 1  ,  precio: 1050 ,  img: '../gallery/pk-mascota.png' },       
    {id: 6, nombre: "Moschino"   ,cantidad: 1  ,  precio:  870  ,  img:  '../gallery/pk-mosc.png'  }   
]
...
const eliminarDelCarrito = (expId) => {
    ...
    vaciarCarrito.addEventListener('click', () => {
        carrito.length = 0 //dependiendo de lo que haya en el carrito, este al hacer click en el boton vaciar carrito vuelve a 0 
